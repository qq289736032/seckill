package com.jisen.seckill.exception;
...
public class GlobalExceptionAdvice {
    ...
    public Result<String> exceptionHandler(HttpServletRequest request, Exception e) {
        ...
        if (e instanceof GlobalException) {
            ...
            String msg = CodeMsg.BIND_ERROR.getMsg();
            CodeMsg.BIND_ERROR.setMsg(String.format(msg, message));
            return Result.error(CodeMsg.BIND_ERROR);// 将错误信息动态地拼接到已定义的部分信息上
        } else {
